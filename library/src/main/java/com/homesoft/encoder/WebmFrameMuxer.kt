...
class WebmFrameMuxer(path: String, private val fps: Float) : FrameMuxer {
    companion object {
        private val TAG: String = WebmFrameMuxer::class.java.simpleName
    }
    ...
    private val muxer: MediaMuxer = MediaMuxer(path, MediaMuxer.OutputFormat.MUXER_OUTPUT_WEBM)
